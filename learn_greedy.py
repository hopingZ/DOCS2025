...
class Collector:
    ...
    def collect(self):
        ...
        if level > 0.5:
            ...
            self.instance_settings[0]['num_orders'] = min(self.instance_settings[0]['num_orders'], 20)
            self.last_total_rewards.clear()
            torch.save(self.old_policy_net.state_dict(), 'old_policy_net_0724_greedy.pth')
